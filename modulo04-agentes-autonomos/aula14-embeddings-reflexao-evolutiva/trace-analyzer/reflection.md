...
critica:
  criterios:
    - completude: todas as fases do trace foram analisadas?
    - profundidade: anomalias foram investigadas com detalhe suficiente?
    - acionabilidade: recomendacoes sao praticas e especificas?
  limiar_aprovacao: 70
  max_reflexoes: 2
  formato_critica:
    nota: int (0-100)
...
aprendizado:
  ...
  extracao_licoes:
    ...
    politicas:
      - so extrair licao se o resultado foi inesperado
      - licoes devem ser generalizaveis
