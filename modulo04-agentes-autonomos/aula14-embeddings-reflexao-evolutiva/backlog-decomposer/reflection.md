...
critica:
  criterios:
    - completude: todas as historias cobrem os componentes identificados?
    - qualidade: cada historia tem criterios de aceitacao claros?
    - granularidade: historias estao no tamanho certo?
  limiar_aprovacao: 70
  max_reflexoes: 2
  formato_critica:
    nota: int (0-100)
