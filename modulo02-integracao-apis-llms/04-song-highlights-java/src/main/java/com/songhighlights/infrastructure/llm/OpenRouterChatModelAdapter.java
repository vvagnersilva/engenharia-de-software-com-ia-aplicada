package com.songhighlights.infrastructure.llm;
...
/**
 * Implementação de ChatModelPort usando o ChatClient do Spring AI,
 ...
 */
@Component
public class OpenRouterChatModelAdapter implements ChatModelPort {

    private final ChatClient chatClient;

    public OpenRouterChatModelAdapter(ChatClient.Builder chatClientBuilder) {
